            ...
            <div>
                <div className="px-6 py-4 bg-white">
                    ...
                    <Link href="#" title="home" >
                        {/* Next/Image */}
                        <Image src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7RDEtPGvqNOxsei62fAUnKqBZkR5tyrOilA&s"
                            alt="tailus logo"
                            width={200}
                            height={200}
                        />
                ...
                <div className="mt-8 text-center">
                    ...
                    <Image
                        src="https://avatars.githubusercontent.com/u/94113125?s=200&v=4"
                        width={150}
                        height={150}
                        alt=""
