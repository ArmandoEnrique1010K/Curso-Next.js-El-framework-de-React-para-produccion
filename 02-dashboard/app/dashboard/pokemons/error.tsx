// Código obtenido de: https://nextjs.org/docs/app/getting-started/error-handling#nested-error-boundaries

"use client";

import { useEffect } from "react";

// Por defecto tiene 2 parametros: error y unstable_retry
export default function ErrorPage({
  ...
  //       {/* error es un objeto de tipo Error */}
  //       {/* Se obtiene el mensaje del error definido en throw new Error de la página que
  //       se encuentra en app/pokemons/page.tsx */}
  //       <span>{error.toString()}</span>

  //       {/* Botón para volver a intentar la petición */}
  //       <button onClick={() => unstable_retry()}>Try again</button>
  //     </div>
  //   );

  return (
    // Código fuente obtenido de: https://www.creative-tim.com/twcomponents/component/tailwind-css-500-server-error-illustration
    <div className="w-full h-screen flex flex-col items-center justify-center">
      {/* Icono propio del componente de Tailwind CSS */}
      <svg
        className="w-1/2 md:w-1/3 lg:w-1/4 text-blue-600"
        xmlns="http://www.w3.org/2000/svg"
        data-name="Layer 1"
        viewBox="0 0 1119.60911 699"
        // No olvidar cambiar xmlns:xlink por xmlnsXlink
